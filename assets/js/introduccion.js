...
switch (operation) {
    case "+":
        ...
        window.alert(`Suma: ${suma(n1,n2)}`);
        break;
    case "-":
        console.log(`Resta: ${resta(n1,n2)}`);
        window.alert(`Resta: ${resta(n1,n2)}`);
        break;
    case "*":
        console.log(`Multiplicacion: ${multiplicacion(n1,n2)}`);
        window.alert(`Multiplicacion: ${multiplicacion(n1,n2)}`);
        break;
    case "/":
        console.log(`Division: ${division(n1,n2)}`);
        window.alert(`Division: ${division(n1,n2)}`);
        break;
    case "%":
        console.log(`Modulo: ${module(n1,n2)}`);
        window.alert(`Modulo: ${module(n1,n2)}`);
        break;
    default:
        console.log("Operacion no valida");
        window.alert("Operacion no valida");
        break;
}
